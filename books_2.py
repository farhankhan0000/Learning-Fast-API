...
BOOKS = [Book(1, "Computer Science Pro", "codingwithfarhan", "A very nice Book", 5, 2030),
         Book(2, "Be Fast With FastAPI", "codingwithfarhan", "This is a great book",5, 2030),
         Book(3, "Master endpoints","codingwithfarhan", "A awesome book", 5, 2029),
